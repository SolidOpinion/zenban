...
export class App {
    ...
    configureRouter(config, router) {
        ...
        config.map([
            ...
            { route: "request", moduleId: "controllers/request", nav: false, title: "New request", name: "request"},
            { route: "request/:id", moduleId: "controllers/request", nav: false, title: "Edit request", name: "request"}
        ]);
    }
